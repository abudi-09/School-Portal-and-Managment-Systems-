...
const AttendanceTracking = () => {
  ...
  const attendanceRecords = [
    { date: '2024-03-01', subject: 'Mathematics', status: 'present', teacher: 'Mrs. Johnson' },
    { date: '2024-03-01', subject: 'English', status: 'present', teacher: 'Mr. Smith' },
    { date: '2024-03-02', subject: 'Physics', status: 'absent', teacher: 'Dr. Brown', reason: 'Sick leave' },
    { date: '2024-03-02', subject: 'Chemistry', status: 'present', teacher: 'Dr. Lee' },
    { date: '2024-03-03', subject: 'Biology', status: 'late', teacher: 'Dr. Wilson' },
    { date: '2024-03-03', subject: 'History', status: 'present', teacher: 'Ms. Davis' },
    { date: '2024-03-04', subject: 'Mathematics', status: 'present', teacher: 'Mrs. Johnson' },
    { date: '2024-03-04', subject: 'English', status: 'excused', teacher: 'Mr. Smith', reason: 'School event' },
    { date: '2024-03-05', subject: 'Geography', status: 'present', teacher: 'Mr. Taylor' },
    { date: '2024-03-05', subject: 'Physical Education', status: 'absent', teacher: 'Coach Martinez', reason: 'Medical' },
  ];
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'present':
        return <Badge className="bg-green-500/10 text-green-600 hover:bg-green-500/20">Present</Badge>;
      case 'absent':
        return <Badge variant="destructive">Absent</Badge>;
      case 'late':
        return <Badge className="bg-yellow-500/10 text-yellow-600 hover:bg-yellow-500/20">Late</Badge>;
      case 'excused':
        return <Badge className="bg-blue-500/10 text-blue-600 hover:bg-blue-500/20">Excused</Badge>;
      default:
    ...
    <div className="p-4 md:p-8 space-y-6">
      ...
      {attendancePercentage < 75 && (
        <Alert variant="destructive">
          ...
          <AlertDescription>
            Your attendance is below 75% — you may be restricted from midterm or final exams. 
            Please improve your attendance immediately or consult with your class teacher.
          </AlertDescription>
        </Alert>
      )}
