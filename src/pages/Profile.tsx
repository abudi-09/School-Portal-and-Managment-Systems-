...
import { User, Mail, Phone, Calendar, MapPin, Briefcase, Lock, Camera } from "lucide-react";
          ...
          <div className="flex items-center gap-6">
            <div className="relative">
              <div className="w-24 h-24 rounded-full bg-accent flex items-center justify-center">
                <span className="text-3xl font-bold text-accent-foreground">JS</span>
              </div>
              <Button
                size="icon"
                variant="secondary"
            ...
            <div>
              <h2 className="text-2xl font-bold text-foreground">{studentInfo.fullName}</h2>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-sm text-muted-foreground mt-4">
                To update guardian information, please contact the school administration.
              </p>
            </CardContent>
          </Card>
        </TabsContent>
